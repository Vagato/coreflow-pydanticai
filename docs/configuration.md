...
|----------|---------|-------------|
| `PROJECT_NAME` | `coreflow` | Display name for the project |
...
| `POSTGRES_DB` | `coreflow` | Database name |
...
| `LOGFIRE_SERVICE_NAME` | `coreflow` | Service name in Logfire dashboard |
...
| `S3_RAG_BUCKET` | `coreflow-rag` | Bucket name |
